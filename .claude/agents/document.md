...
Write the description as a human engineer would write it — clear, direct, and professional. Do not include any mention of AI, Claude, or code generation tools. No "Generated by", "Co-authored by AI", "🤖", or any similar attribution. The description should read as if the engineer who built the feature wrote it themselves.

Write it so a senior engineer who has never seen this PR could read it and fully understand what was built, why, and how. Include:

- **What this PR does** — a plain-language summary of the feature (drawn from the spec)
