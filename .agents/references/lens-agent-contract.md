...
**DONE / DONE_WITH_CONCERNS / NEEDS_CONTEXT / BLOCKED** — plus a one-line summary. Lens roles do not have interactive-question or nested-worker capabilities, so they
