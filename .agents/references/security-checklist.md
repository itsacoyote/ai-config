...
Actionable quick-ref for web application security: copy-paste snippets and pre-commit checks. For the authoritative preventive guidance and the full OWASP Top 10 prevention map, see `../skills/security-and-hardening/SKILL.md`. For vulnerability detection patterns, see `../skills/security-scan/references/vuln-categories.md`.
...
For the full OWASP Top 10 prevention map (all 10 categories, with code examples), see the canonical preventive home: `../skills/security-and-hardening/SKILL.md#owasp-top-10-prevention`.
