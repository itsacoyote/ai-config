...
description: Use when a spec or clear requirements need to become a dependency-ordered file map and implementable tasks with acceptance criteria, named tests, and verification.
metadata:
  category: workflow
---
...
Skip this skill for single-file changes with obvious scope, or when the approved spec already contains dependency-ordered tasks with complete file maps, tests, and verification.
...
labels registry in [`beads.md`](../../references/beads.md)), and these plus
