...
description: Use when writing or reviewing TypeScript, especially type modeling, runtime boundaries, inference, narrowing, generics, and compiler strictness.
metadata:
...
- A project-specific convention or compiler configuration overrides a general preference here.
- The task is only JavaScript behavior and introducing types would expand the requested scope.
