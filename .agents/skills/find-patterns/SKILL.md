---
name: find-patterns
description: Use when researching or preparing to implement in an unfamiliar code area where existing conventions, patterns, and architectural decisions need to be identified.
