...
For a fast pre-commit pass, use [`security-checklist.md`](../../references/security-checklist.md) — it has copy-paste security headers, CORS configuration, pre-commit grep checks, and dependency audit commands. That file is a quick-ref that links back here for the authoritative prevention guidance.

## See Also

- [`security-checklist.md`](../../references/security-checklist.md) — actionable quick-ref: pre-commit checks, copy-paste headers/CORS/error snippets
