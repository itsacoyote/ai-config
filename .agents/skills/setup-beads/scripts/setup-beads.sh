...
#   6. Ensures .beads/ is in .git/info/exclude.
#   7. Verifies `bd version` / `bd ready` and prints a recap.
#
# Harness-specific hooks and permissions are intentionally out of scope.
#
...
ok ".beads/ excluded locally (.git/info/exclude)"
...
echo "  • exclude     : .beads/ in .git/info/exclude"
echo "  • harness     : hooks and permissions unchanged"
echo
