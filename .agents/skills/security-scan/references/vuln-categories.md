...
For the canonical **prevention** guidance (OWASP Top 10 prevention map, code patterns, hardening rules), see [`security-and-hardening`](../../security-and-hardening/SKILL.md).
