---
name: security-scan
description: Use when a code change needs an independent vulnerability audit for injection, access-control flaws, secrets exposure, weak cryptography, insecure dependencies, or business-logic risks.
metadata:
