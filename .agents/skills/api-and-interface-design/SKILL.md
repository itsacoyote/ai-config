...
For general TypeScript type-modeling techniques (discriminated unions, `as const`, branded types, and deriving types from values), use the portable `typescript-tips` skill rather than restating them here.
