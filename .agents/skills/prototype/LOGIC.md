...
When the prototype has done its job, the answer to the question is the only thing worth keeping. Record it per the "When done" section of [SKILL.md](SKILL.md) — a beads comment on the issue the prototype served, or a placeholder next to the prototype until the verdict is in.
