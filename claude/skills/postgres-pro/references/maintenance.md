...
-- Vacuum thresholds (verify defaults for your version)
autovacuum_vacuum_threshold = 50
autovacuum_vacuum_scale_factor = 0.2
-- Triggers when: dead_tuples > threshold + (scale_factor * total_tuples)
-- e.g. at scale_factor 0.2, a 1M-row table waits for ~200K dead tuples —
-- far too lazy for high-churn tables, so tune scale_factor down per-table
